    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('Welcome') ?>">
                ...
                <div class="sidebar-brand-icon">  <span class="material-icons">checkroom</span><br>          
                <div class="sidebar-brand-text mx-3">Ancis Store</div>
                </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="navbar">
                            <ul class="nav navbar-nav navbar-right mt-2">
                                <li>
                                    <?php $keranjang = '' .$this->cart->total_items(). '<span class="material-icons">local_grocery_store</span>'
                                    ?>
                                ...
                                <li><div><?php echo $this->session->userdata('username') ?></div></li></ul>
